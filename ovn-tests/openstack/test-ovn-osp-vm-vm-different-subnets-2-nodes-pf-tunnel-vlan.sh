#!/bin/bash
#
# Test traffic VM to VM on different subnet different nodes with tunnel over vlan configured with OSP and OVN then verify traffic is offloaded
#
...
function config_test() {
    ...
    on_remote_exec "config_ovn_pf_vlan_int $ovn_central_ip $ovn_remote_controller_ip SERVER_VF SERVER_REP
