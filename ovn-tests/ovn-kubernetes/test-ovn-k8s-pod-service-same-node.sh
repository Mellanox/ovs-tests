...
function run_test() {
    ...
    check_local_tcp_traffic_offload $CLIENT_REP $CLIENT_NS $SERVER_NS $LB_IPV4

    title "Test UDP traffic between $CLIENT_VF($CLIENT_IPV4) -> $SERVER_VF($LB_IPV4) offloaded"
    check_local_udp_traffic_offload $CLIENT_REP $CLIENT_NS $SERVER_NS $LB_IPV4
    ...
    check_local_tcp6_traffic_offload $CLIENT_REP $CLIENT_NS $SERVER_NS $LB_IPV6

    title "Test UDP6 traffic between $CLIENT_VF($CLIENT_IPV6) -> $SERVER_VF($LB_IPV6) offloaded"
    check_local_udp6_traffic_offload $CLIENT_REP $CLIENT_NS $SERVER_NS $LB_IPV6
}
