#!/bin/bash
#
# Verify traffic for OVN-Kubernetes pod to pod on different nodes with VF LAG tunnel over vlan
#
...
function config_test() {
    ...
    config_ovn_k8s_vf_lag_vlan $CLIENT_NODE_IP $CLIENT_NODE_IP $CLIENT_NODE_IP_MASK $CLIENT_NODE_MAC $OVN_K8S_VLAN_NODE1_TUNNEL_IP CLIENT_VF CLIENT_REP
    ...
    on_remote_exec "config_ovn_k8s_vf_lag_vlan $CLIENT_NODE_IP $SERVER_NODE_IP $SERVER_NODE_IP_MASK $SERVER_NODE_MAC $OVN_K8S_VLAN_NODE2_TUNNEL_IP SERVER_VF SERVER_REP
