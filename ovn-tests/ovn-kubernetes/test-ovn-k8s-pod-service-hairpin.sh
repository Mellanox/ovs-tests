...
function run_test() {
    ...
    title "Test ICMP traffic between $CLIENT_VF($CLIENT_IPV4) -> $CLIENT_VF($LB_IPV4) offloaded"
    ...
    title "Test ICMP6 traffic between $CLIENT_VF($CLIENT_IPV6) -> $CLIENT_VF($LB_IPV6)"
