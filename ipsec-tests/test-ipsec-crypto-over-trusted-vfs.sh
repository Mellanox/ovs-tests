...
# NOTE: tunnel mode is not included in this test yet.
...
function run_test() {
    run_test_ipsec_offload 1500 ipv4 transport tcp trusted_vfs
    run_test_ipsec_offload 9000 ipv4 transport tcp trusted_vfs
}
