...
function run_test() {
    run_test_ipsec_offload 1500 ipv6 transport icmp no_trusted_vfs full_offload
    run_test_ipsec_offload 9000 ipv6 transport icmp no_trusted_vfs full_offload
}
