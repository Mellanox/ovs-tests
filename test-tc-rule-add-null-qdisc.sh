...
tc filter add dev $NIC protocol 0x800 ingress prio 10 handle 1 flower skip_hw dst_mac e4:11:22:33:44:50 ip_proto udp dst_port 1 src_port 1 action gact drop &>/dev/null
[ $? -eq 0 ] && err || success
