#!/bin/bash
#
# Test OVS-DPDK with IPv6 vxlan traffic
#
...
function config() {
    ...
    config_tunnel vxlan 1 br-phy br-int $TUNNEL_ID $LOCAL_IP $IPV6_LOCAL_TUNNEL_IP
    config_local_tunnel_ip $IPV6_REMOTE_TUNNEL_IP br-phy 112

    on_remote_exec "config_tunnel vxlan 1 br-phy br-int $TUNNEL_ID $REMOTE_IP $IPV6_REMOTE_TUNNEL_IP
