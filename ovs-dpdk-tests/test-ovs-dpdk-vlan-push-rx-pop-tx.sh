...
function add_openflow_rules() {
    ...
    ovs-ofctl add-flow br-int "in_port=vxlan_br-int,actions=push_vlan:0x8100,mod_vlan_vid:7, output:$REP" -O OpenFlow11
    ovs-ofctl add-flow br-int "in_port=$REP,dl_vlan=7,actions=pop_vlan, output:vxlan_br-int" -O OpenFlow11
