...
function add_openflow_rules() {
    ...
    ovs-ofctl add-flow br-int "table=0,in_port=vxlan_br-int,ip,actions=mod_nw_src=$FAKE_IP,$REP"
    ovs-ofctl add-flow br-int "table=0,in_port=$REP,ip,actions=mod_nw_dst=$REMOTE_IP,vxlan_br-int"
