...
# We currently support offload with 32bits label and not full 128bits but test
# sw traffic.
# So we do expect to see an error msg in the dmesg like this
# [ 1296.979205] mlx5_core 0000:82:00.0 ens1f0: Failed to offload ct entry, err: -95
