...
function check_offloaded_rules() {
    ...
    RES="ovs-dpctl dump-flows type=offloaded | grep 0x086DD | grep \"ipv6(src=200\""
    eval $RES
    RES=`eval $RES | wc -l`
