#!/bin/bash
#
# Test offloading on vxlan setup with VF as tunnel endpoint + CT and concurrent
# route change.
#
# Require external server
#
# Bug SW #3544096: [Upstream] Call trace with basic CT checks over stacked devices configuration
