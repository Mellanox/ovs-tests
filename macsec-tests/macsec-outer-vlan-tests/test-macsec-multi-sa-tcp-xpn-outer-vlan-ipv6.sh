...
function run_test() {
    run_test_macsec --mtu 1500 --ip-proto ipv4 --macsec-ip-proto ipv4 --net-proto tcp --offload-side both --multi-sa on --xpn on --outer-vlan --vlan-ip-proto ipv6 --outer-vlan --vlan-ip-proto ipv6
}
